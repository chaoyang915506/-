...
export function compareDate (prop, align) {
  return function (a, b) {
    ...
    let dateTime1 = Number(date1.getHours()) * 3600 + Number(date1.getMinutes()) * 60
    let dateTime2 = Number(date2.getHours()) * 3600 + Number(date2.getMinutes()) * 60
    ...
    // } else if (align == "inverted") {//倒序
    //   return new Date(dateTime2) - new Date(dateTime1);
    // }
  }
}
// 时间戳转小时分钟
