...
export const constantRoutes = [
  ...
  // 不放在上面的children是因为导航页是单独的页面
  // {
  //   path: '/SimLayout/layout/mapManageL',
  //   component: () => import('@/simLayout/layout/mapManageL'),
  //   name: 'mapManageL',
  //   children: [
  //     {
  ...
  //           component: () => import('@/views/equitComp/meteorological/meteorological'),
  //           name: 'meteorological',
  ...
  // },
  // {
  //   path: '/SimLayout/layout/mapTestL',
  //   component: () => import('@/simLayout/layout/mapTestL'),
  //   name: 'mapTestL',
  //   children: [
  //     {
  //       path: '/SimLayout/layout/mapTestL/algLibrary',
  //       component: () => import('@/views/compTest/algLibrary/algLibrary'),
  //       name: 'algLibrary',
  //       meta: { title: '算法库', icon: 'dashboard', affix: true }
  //     },
  //     {
  //       path: '/SimLayout/layout/mapTestL/dataSet',
  //       component: () => import('@/views/compTest/dataSet/dataSet'),
  //       name: 'dataSet',
