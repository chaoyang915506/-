<template>
  <div class="app-container">
    ...
    <el-form :model="form" :inline="true" size="normal">
      <el-form-item>
        <el-select v-model="selectModel" @change="clearSelect" placeholder="">
      ...
      <el-form-item>
        ...
        <el-select
          ...
          placeholder="请选择算法种类"
        >
          <el-option label="场景识别算法" value="3"></el-option>
          <el-option label="场景分割算法" value="4"></el-option>
          <el-option label="材质识别算法" value="8"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
...
const { scene_type, texture, alg_type } = proxy.useDict(
  "alg_type",
  "scene_type",
  "texture"
);
...
getList();
//获取icon的数据
getmodelCount({ modelType: 1 }).then((res) => {
  let arrlist = [];
  // console.log(res.data, "icon数量数据");
