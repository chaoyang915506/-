<template>
  <div class="fz-container">
    <!-- 图标 -->
    <div class="icon_list_style" v-if="weatherData && weatherData.length !== 0">
      <weather-icon
    ...
    <el-form :model="form" :inline="true" size="small">
      ...
      <!-- <el-form-item>
				<el-select v-model="selectModel" placeholder="" @change="clearSelect">
					...
					<el-option label="按适用场景" value="3"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item>
				<el-date-picker
...
const clearSelect = () => {
  data.queryParams = { pageNum: 1, pageSize: 10 };
  data.timePicker = [];
};
const {
  weatherData,
