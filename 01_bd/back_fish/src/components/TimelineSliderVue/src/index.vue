  ...
  <div class="timeline-container">
    ...
    >
      <div slot="sliderContent" class="slider-content">
        <slot name="sliderContent" :data="dateValue" />
      </div>
    </MainView>
    <el-button
      v-if="playState"
    ...
    <el-button
      ...
      >停止</el-button
    >
    <!-- <button v-if="playState" @click="play">play</button>
...
export default {
  ...
  mounted() {
    ...
    if (this.date) {
      ...
      // dateFormat 输入当天的ISO，输出2022-08-29
  ...
  methods: {
    ...
    judjeMoreNearly(date, dateList) {
      ...
      const dateListParse = dateList.map((_) =>
        Date.parse(_.replace(/-/g, "/"))
      );
