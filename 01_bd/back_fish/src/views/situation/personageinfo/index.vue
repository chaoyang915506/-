...
export default {
  ...
  methods: {
    pushinfo(i) {
      // console.log(this.$refs.content.scrollTop, "red");
      document.querySelector(".app").scrollTop = 0;
      // document.documentElement.scrollTop = -1999;
      // return;
      // console.log(i, "idididididid");
      // // this.ids = i.orgUserId;
      // window.scrollTo(0, 0);
      this.$router.push({
        path: "/situationPersonageInfo",
        query: { id: i.orgUserId },
      });
      this.getallinfo();
      // window.scrollTop = this.$refs.content.scrollTop;
